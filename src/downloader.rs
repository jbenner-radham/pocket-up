...
// fn build_http_client() -> reqwest::blocking::Client {
//     let mut default_headers = HeaderMap::new();
//     let auth_value = Some(HeaderValue::from_static(
//         "Bearer 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",
//     ));

//     if let Some(mut auth_value) = auth_value {
//         auth_value.set_sensitive(true);
//         default_headers.insert(header::AUTHORIZATION, auth_value);
//     }
...
// https://github.com/Mazamars312/Analogue_Pocket_Neogeo/releases/latest
// li.Box-row:nth-child(1) > div:nth-child(1) > a:nth-child(2)
// pub fn fetch_neogeo_core() {
//     let url = "https://api.github.com/repos/Mazamars312/Analogue_Pocket_Neogeo/releases/latest";
//     let client = build_http_client();
//     let response = client
//         .get(url)
//         .send()
//         .expect("Should have been able to fetch the HTTP document");
//     let text = response
//         .text()
...
//     let url = if json["assets"].is_array() && !json["assets"].as_array().unwrap().is_empty() {
//         let asset = &json["assets"][0];

//         if asset["browser_download_url"].is_string() {
//             asset["browser_download_url"].as_str().unwrap()
//         } else {
//             ""
//         }
//     } else {
...
//     match fs::write(format!("/home/james/Development/{filename}"), bytes) {
//         Ok(_) => println!("Successfully downloaded /home/james/Development/{filename}"),
